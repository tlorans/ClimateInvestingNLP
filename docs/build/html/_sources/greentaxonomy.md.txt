...
We follow Alessi and Battiston, 2022 {cite:p}`2022:AlessiBattiston` by adopting the list of green activities from the EU taxonomy (we combine both green and enabling technologies, but exclude transitional activities), as listed in the Annex 1 {cite:p}`2021:ANNEX1`. However, due to the lack of data, we cannot follow the alignment process recommended by the EU taxonomy. Our approach stops at the first stage: the **eligibility**.
